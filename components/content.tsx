...
export const Content = () => {
    return (
        ...
        >
            ...
            className='cursor-pointer group relative text-neutral-500 px-12 py-4 rounded-lg bg-black shadow-[0px_1px_2px_0px_rgba(255, 255, 255, 0.1)_inset,0px_-1px_2px_0px_rgba(255, 255, 255, 0.1)_inset]'>
                <span className='group-hover:text-cyan-300 transition-colors duration-300'>Subscribe</span>
